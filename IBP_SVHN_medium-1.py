...
#SAVING RESULTS
with open('./SVHN_medium/results_IBP_SVHN_medium.txt', 'w') as f:
...
np.savetxt("./SVHN_medium/IBP_SVHN_medium_EPSILON_"+str(EPSILON)+"EPSILON_TRAIN_"+ str(EPSILON_TRAIN)+"_Test_Error_Rate.txt", test_err_tab)
np.savetxt("./SVHN_medium/IBP_SVHN_medium_EPSILON_"+str(EPSILON)+"EPSILON_TRAIN_"+ str(EPSILON_TRAIN)+"_PGD_Error_Rate.txt", pgd_test_err_tab)
np.savetxt("./SVHN_medium/IBP_SVHN_medium_EPSILON_"+str(EPSILON)+"EPSILON_TRAIN_"+ str(EPSILON_TRAIN)+"_Verified.txt", ver_test_err_tab)


#SAVING WEIGHTS
torch.save(model.state_dict(), 'weights_IBP_SVHN_medium.pth')